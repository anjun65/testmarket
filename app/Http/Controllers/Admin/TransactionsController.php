...
class TransactionsController extends Controller
{
        ...
        if(request()->ajax())
        {
            ...
            return Datatables::of($query)
                ->addcolumn('action', function($item) {
                    return '
                        <div class="btn-group">
                            <a class="btn btn-primary" href="' . route('transactions.edit', $item->id) . '">
                                Proses
                            </a>
                        </div>
                    ';
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($item->transaction_status == 'Proses'){
            ...
            return redirect()->route('transactions.index')->with(['error' => 'Data tidak bisa diubah karna sudah dihandle oleh sales lain.']);
        }
